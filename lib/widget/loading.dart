...
class LoadingView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return switch (index > 0 ? index : Random().nextInt(17)) {
      ...
      10 => LoadingAnimationWidget.beat(color: color, size: size),
      11 => LoadingAnimationWidget.twoRotatingArc(color: color, size: size),
      12 =>
        LoadingAnimationWidget.horizontalRotatingDots(color: color, size: size),
      13 => LoadingAnimationWidget.newtonCradle(color: color, size: size),
      14 => LoadingAnimationWidget.stretchedDots(color: color, size: size),
      15 => LoadingAnimationWidget.halfTriangleDot(color: color, size: size),
      16 => LoadingAnimationWidget.dotsTriangle(color: color, size: size),
